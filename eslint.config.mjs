...
export default defineConfig([
  ...
  {
    // The binary encoder retains its tested JavaScript implementation.
    // Public boundaries have JSDoc types; keep typed rules on all callers.
    files: ["src/io/affinity/*.mjs"],
    rules: {
      ...
      // These are native paragraph records, not HTML element styles.
